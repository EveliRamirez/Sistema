...
$("#nuevoPrecioCompra, #editarPrecioCompra").change(function(){
    ...
    if($(".porcentaje").prop("checked")){
        ...
        porcentaje = redondearPrecio(porcentaje); 
        console.log("Nuevo Precio de Venta:", porcentaje); 

        var editarPorcentaje = Number($("#editarPrecioCompra").val()) * (1 + valorPorcentaje / 100);
        editarPorcentaje = redondearPrecio(editarPorcentaje); 
        console.log("Editar Precio de Venta:", editarPorcentaje); 
...
function redondearPrecio(valor) {
    ...
    if (Math.abs(decimales - 0.5) < 0.00001) { 
