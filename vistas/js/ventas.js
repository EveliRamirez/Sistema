...
function agregarImpuesto() {
    ...
    // Redondeo del precio 
    precioImpuesto = redondeoPersonalizado(precioImpuesto);

    if ($("#nuevoTotalVenta").length > 0) {
        totalConImpuesto = redondeoPersonalizado(totalConImpuesto);
    }
...
function redondeoPersonalizado(numero) {
    ...
    if (parteDecimal >= 0.75) {
        ...
        console.log("Redondeado a:", redondeado);
        return redondeado;
    } else if (parteDecimal >= 0.5) {
       
        var redondeado = Math.floor(numero) + 0.75;
        console.log("Redondeado a:", redondeado);
        return redondeado;
    } else if (parteDecimal >= 0.25) {
        
        var redondeado = Math.floor(numero) + 0.50;
        console.log("Redondeado a:", redondeado);
        return redondeado;
    } else {
